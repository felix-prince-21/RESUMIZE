...
if ($_SERVER["REQUEST_METHOD"] === "POST") {
    ...
    $sql = "UPDATE skill SET JobTitle=?, OrganizationName=?, startDate=?, endDate=? , JobDescription = ?, WHERE skill_id=?";
    $stmt = $conn->prepare($sql);
    $stmt->bind_param("ssssi", $job_title, $organization_name, $start_date, $end_date, $job_description, $skillId);
